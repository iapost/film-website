...
if(isset($_POST['token'])){
	...
	if($response==false){
		...
		if(!isset($res['roles'][0]['name'])||$res['roles'][0]['name']=='USER'){//either admins or owners can access this
...
$coll->updateMany(array(),array('$pull'=>array('favorites'=>array('mid'=>$_POST['mid']))));
$coll->updateMany(array(),array('$pull'=>array('notifications'=>array('id'=>$_POST['mid']))));
echo('OK');
?>
